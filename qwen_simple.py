...
class SimpleQwenGenerator:
    ...
    def generate_image(self, prompt, output_name, size="1024*1024"):
        """Generate image using HTTP API"""
        
        # Enhance prompt for children's books
        enhanced_prompt = f"Children's book illustration, cute friendly style, {prompt}, bright colors, simple background, no text"
        ...
        payload = {
            ...
            "parameters": {
                "negative_prompt": "low resolution, low quality, deformed limbs, blurry text, distorted text, watermark",
                "prompt_extend": True,
                "watermark": False,
                "size": size,
                "n": 1
